<h3 align="center">Hi 👋, I'm Apu!</h3>
<h4 align="center">A passionate AI & Machine Learning enthusiast from Bangladesh</h4>
...
- 🔬 I'm currently working on my research: **Fraud Detection in Digital Payments Using Big Data Analytics**
- 🧠 I'm currently learning **advanced Machine Learning, Big Data Analytics, and Spring Boot**
- 🐍 I'm building daily practice projects in **Python** — from fundamentals to real mini-projects
- 🎨 All of my creative web projects are shared via **Netlify Drop**
...
<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=apupaul-ai&theme=radical&hide_border=true" alt="streak stats" />
</p>

<h3 align="left">Featured / Ongoing Work:</h3>

| Project | Description |
|---|---|
| 🕵️ Fraud Detection in Digital Payments | Big data + ML pipeline (LogReg, Random Forest, XGBoost, Ensemble) for detecting fraudulent transactions |
| 🐍 Python Daily Practice | Structured day-by-day Python learning journey, including a calculator build project |
| 🎁 Creative Web Pages | Small HTML/CSS/JS interactive pages built for fun, deployed via Netlify Drop |
